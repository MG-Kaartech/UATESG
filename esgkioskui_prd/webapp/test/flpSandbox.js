		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "ESG Driver Kiosk",
									"targetURL": "#commgcesgdriverkioskprdesgkioskuiprd-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"commgcesgdriverkioskprdesgkioskuiprd-display": {
								"semanticObject": "commgcesgdriverkioskprdesgkioskuiprd",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.mgc.esgdriverkioskprd.esgkioskuiprd",
									"url": sap.ui.require.toUrl("com/mgc/esgdriverkioskprd/esgkioskuiprd")
								}
							}
						}
					}
